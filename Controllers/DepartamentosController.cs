...
namespace ExamenComercioElectronico.Controllers
{
    public class DepartamentosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "codigo,nombre,ubicacion")] Departamentos departamentos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "codigo,nombre,ubicacion")] Departamentos departamentos)
        {
            if (ModelState.IsValid)
            {
